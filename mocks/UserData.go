...
import (
	user "my-tourist-ticket/features/user"
...
// UpdatePengelola provides a mock function with given fields: pengelolaStatus, pengelolaId
func (_m *UserData) UpdatePengelola(pengelolaStatus string, pengelolaId int) error {
	ret := _m.Called(pengelolaStatus, pengelolaId)

	if len(ret) == 0 {
		panic("no return value specified for UpdatePengelola")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(string, int) error); ok {
		r0 = rf(pengelolaStatus, pengelolaId)
	} else {
		r0 = ret.Error(0)
	}
